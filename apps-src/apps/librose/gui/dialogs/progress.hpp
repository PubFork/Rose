...
{
public:
	tprogress(const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, bool quantify, int hidden_ms, bool show_cancel, int best_width, int best_height, const boost::function<void (ttrack&, const SDL_Rect&, int, const std::string&)>& did_draw_bar);
	~tprogress();
