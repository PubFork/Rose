...
tprogress::tprogress(const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, bool quantify, int hidden_ms, bool show_cancel, int best_width, int best_height, const boost::function<void (ttrack&, const SDL_Rect&, int, const std::string&)>& did_draw_bar)
	: message_(message)
...
void tprogress::pre_show()
{
	...
	progress_.reset(new tprogress_bar(*window_, find_widget<twidget>(window_, "_progress", false), message_, quantify_, did_draw_bar_));
...
bool run_with_progress(const std::string& message, const boost::function<bool (tprogress_&)>& did_first_drawn, bool quantify, int hidden_ms, bool show_cancel, const SDL_Rect& rect, const boost::function<void (ttrack&, const SDL_Rect&, int, const std::string&)>& did_draw_bar)
{
	gui2::tprogress dlg(message, did_first_drawn, quantify, hidden_ms, show_cancel, rect.w, rect.h, did_draw_bar);
