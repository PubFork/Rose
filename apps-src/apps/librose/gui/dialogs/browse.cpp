...
void tbrowse::pre_show()
{
	...
	if (!game_config::mobile) {
		list.set_did_row_double_click(boost::bind(&tbrowse::did_item_double_click, this, _1, _2));
	}
	list.set_did_row_changed(boost::bind(&tbrowse::did_item_selected, this, _1, _2));
...
void tbrowse::init_entry(twindow& window)
{
	...
	root.set_did_row_changed(boost::bind(&tbrowse::did_root_changed, this, _1, _2));
