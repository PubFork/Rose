	...
	, use_tex_buf(false)
{
	...
	connect_signal_mouse_left_click(
		*category_alpha_
		, boost::bind(
			...
			, this, boost::ref(*category_alpha_)));
	...
	connect_signal_mouse_left_click(
		*category_symbol_
		, boost::bind(
			&tkeyboard::click_category
			, this, boost::ref(*category_symbol_)));
...
{
	return code == 'h' || code == 'o' || code == 'u'? "red-textbox": "textbox";
}
...
void tkeyboard::pre_alpha(tgrid& grid)
{
	...
	english_line1->set_did_item_click(boost::bind(&tkeyboard::did_alpha_clicked, this, _1, _2, boost::ref(grid)));
	...
	chinese_line1->set_did_item_click(boost::bind(&tkeyboard::did_alpha_clicked, this, _1, _2, boost::ref(grid)));
	...
	line2->set_did_item_click(boost::bind(&tkeyboard::did_alpha_clicked, this, _1, _2, boost::ref(grid)));
	...
	line3->set_did_item_click(boost::bind(&tkeyboard::did_alpha_clicked, this, _1, _2, boost::ref(grid)));
	...
	line4->set_did_item_click(boost::bind(&tkeyboard::did_alpha_clicked, this, _1, _2, boost::ref(grid)));
	...
	connect_signal_mouse_left_click(
		*expand_
		, boost::bind(
			...
			, this, boost::ref(grid), boost::ref(*expand_)));
	...
	connect_signal_mouse_left_click(
		*capslock_widget_
		, boost::bind(
			...
			, this, boost::ref(grid), boost::ref(*capslock_widget_)));
	...
	connect_signal_mouse_left_click(
		*fullwidth_alpha_
		, boost::bind(
			...
			, this, boost::ref(*fullwidth_alpha_)));
...
void tkeyboard::pre_symbol(tgrid& grid)
{
	...
	report->set_did_item_click(boost::bind(&tkeyboard::did_symbol_item_clicked, this, _1, _2, boost::ref(grid)));
	...
	connect_signal_mouse_left_click(
		*fullwidth_symbol_
		, boost::bind(
			&tkeyboard::click_fullwidth
			, this, boost::ref(*fullwidth_symbol_)));
...
void tkeyboard::pre_more(tgrid& grid)
{
	...
	report->set_did_item_click(boost::bind(&tkeyboard::did_more_item_clicked, this, _1, _2, boost::ref(grid)));
