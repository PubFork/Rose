...
*/
    ...
    public static boolean setTime(Context context, int year, int month, int day, int hour, int minute, int second) {
        {
            ...
            String value = String.format("system_setdate:%04d%02d%02d.%02d%02d%02d",
                    year, month, day, hour, minute, second);
            setProperty("ctl.start", value);
        }
        return true;
    }
