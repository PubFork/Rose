...
LOCAL_SRC_FILES := \
	...
	$(wildcard $(LOCAL_PATH)/librose/zxing/aztec/*.cpp) \
	$(wildcard $(LOCAL_PATH)/librose/zxing/datamatrix/*.cpp) \
	$(wildcard $(LOCAL_PATH)/librose/zxing/maxicode/*.cpp) \
	$(wildcard $(LOCAL_PATH)/librose/zxing/oned/rss/*.cpp) \
	$(wildcard $(LOCAL_PATH)/librose/zxing/oned/*.cpp) \
	$(wildcard $(LOCAL_PATH)/librose/zxing/pdf417/*.cpp) \
	$(wildcard $(LOCAL_PATH)/librose/zxing/qrcode/*.cpp) \
	$(wildcard $(LOCAL_PATH)/librose/zxing/textcodec/*.cpp) \
	$(wildcard $(LOCAL_PATH)/librose/zxing/*.cpp) \
...
LOCAL_LDFLAGS += -L$(LOCAL_PATH)/../linker/kos/lib
